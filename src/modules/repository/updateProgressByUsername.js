 ...
 */
module.exports = async (username, sectionID, moduleID, progress,progressCompleted) => {
 ...
 const updateParams = {
  TableName: SECTION_MODULES_TABLE,
  Key: { sectionModuleID },
  UpdateExpression: `SET students[${studentIndex}].progress = :s,students[${studentIndex}].progressCompleted = :ss, students[${studentIndex}].#st = :st`,
  ExpressionAttributeNames: {
    "#st": "status", // 👈 alias for reserved keyword
  },
  ExpressionAttributeValues: {
    ":s": progress,
    ":ss": progressCompleted,
